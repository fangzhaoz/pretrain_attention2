...
optimizer2 = torch.optim.AdamW(hidden_matrix_params + gate_params, lr=8e-4,  betas=(0.85, 0.85), eps=1e-10, weight_decay=8e-1, fused=True)
...
for step in range(train_steps + 1):
    ...
    if last_step:
        if master_process and args.save_checkpoint:
            ...
            os.makedirs(f"logs_adamw_small/{run_id}", exist_ok=True)
            torch.save(log, f"logs_adamw_small/{run_id}/state_step{step:06d}.pt")
